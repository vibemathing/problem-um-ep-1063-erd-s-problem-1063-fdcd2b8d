...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1063-erd-s-problem-1063-fdcd2b8d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1063"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1063-erd-s-problem-1063-fdcd2b8d-v1",
      "problem_contract_sha256": "4ba509c36217348dc1d282d5a1e180c383366c8b520c0e9e5074e1b456256b2c",
      "problem_id": "problem:um-ep-1063-erd-s-problem-1063-fdcd2b8d",
      "route_id": "route:um-ep-1063-erd-s-problem-1063-fdcd2b8d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1063-erd-s-problem-1063-fdcd2b8d-source-fidelity-01",
      "graph_id": "graph:um-ep-1063-erd-s-problem-1063-fdcd2b8d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1063-erd-s-problem-1063-fdcd2b8d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1063-erd-s-problem-1063-fdcd2b8d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k\\geq 2$ and define $n_k\\geq 2k$ to be the least value of $n$ such that $n-i$ divides $\\binom{n}{k}$ for all but one $0\\leq i<k$. Estimate $n_k$."
          },
          "statement_sha256": "0d7799772c1e686fd8b5b8ec96935d1cc07ce6c94dfabc3f3e694bfb1a45d025"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1063-erd-s-problem-1063-fdcd2b8d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1063-erd-s-problem-1063-fdcd2b8d-root",
      "route_id": "route:um-ep-1063-erd-s-problem-1063-fdcd2b8d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1063-346736a1b31f",
        "url": "https://www.unsolvedmath.com/problems/EP-1063"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
